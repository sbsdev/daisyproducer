...
the [[http://github.com/egli/daisy-producer][repository]].

* Development

Development of Daisy Producer is done in git. See the [[http://github.com/egli/daisy-producer][github project
