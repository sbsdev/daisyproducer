...
[[daisyproducer][Daisy Producer]] is a system to help you manage the
production process of accessible media. It assumes that you are
transforming the content from hard copy or any electronic format to
[[http://www.daisy.org/projects/pipeline/][DTBook XML]]. Once you have
the DTBook XML the [[http://www.daisy.org/projects/pipeline/][Daisy
Pipeline]] and [[http://www.liblouis.org][liblouis]] can be
...
[[daisyproducer][Daisy Producer]] is released under the terms of the
[[http://www.gnu.org/licenses/agpl.html][GNU Affero General Public
License (AGPL)]].
...
[[daisyproducer][Daisy Producer]] comes with built in documentation.
See the [[http://127.0.0.1:8000/help/][Help link]] in your
installation.
