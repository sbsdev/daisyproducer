...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Word', fields ['grade', 'homograph_disambiguation', 'untranslated', 'type', 'document']
        db.create_unique('dictionary_word', ['grade', 'homograph_disambiguation', 'untranslated', 'type', 'document_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Word', fields ['grade', 'homograph_disambiguation', 'untranslated', 'type', 'document']
        db.delete_unique('dictionary_word', ['grade', 'homograph_disambiguation', 'untranslated', 'type', 'document_id'])
