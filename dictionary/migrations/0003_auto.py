...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Word', fields ['untranslated']
        db.create_index('dictionary_word', ['untranslated'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'Word', fields ['untranslated']
        db.delete_index('dictionary_word', ['untranslated'])
