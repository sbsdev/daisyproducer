...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dictionary_word', 'modified_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Adding field 'Word.created_at'
        db.add_column('dictionary_word', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 29, 14, 37, 59, 405573)), keep_default=False)

        # Adding field 'Word.modified_at'
        db.add_column('dictionary_word', 'modified_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 29, 14, 38, 15, 335453)), keep_default=False)
