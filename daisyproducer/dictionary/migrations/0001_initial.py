...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dictionary_word', (
            ('isConfirmed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('untranslated', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('grade1', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('grade2', self.gf('django.db.models.fields.CharField')(max_length=255)),
    ...
    models = {
        ...
        'dictionary.word': {
            ...
            'document': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['documents.Document']", 'null': 'True', 'blank': 'True'}),
            ...
            'untranslated': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        'documents.document': {
