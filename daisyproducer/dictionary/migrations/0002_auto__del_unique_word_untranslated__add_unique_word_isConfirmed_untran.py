...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Word', fields ['untranslated']
        db.delete_unique('dictionary_word', ['untranslated'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Word', fields ['untranslated']
        db.create_unique('dictionary_word', ['untranslated'])
    ...
    models = {
        ...
        'dictionary.word': {
            ...
            'untranslated': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'documents.document': {
