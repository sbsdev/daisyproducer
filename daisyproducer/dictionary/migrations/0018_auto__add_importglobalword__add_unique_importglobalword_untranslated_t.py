...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImportGlobalWord'
        db.create_table('dictionary_importglobalword', (
            ...
            ('type', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True)),
            ('homograph_disambiguation', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('dictionary', ['ImportGlobalWord'])

        # Adding unique constraint on 'ImportGlobalWord', fields ['untranslated', 'type', 'grade', 'homograph_disambiguation']
        db.create_unique('dictionary_importglobalword', ['untranslated', 'type', 'grade', 'homograph_disambiguation'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ImportGlobalWord', fields ['untranslated', 'type', 'grade', 'homograph_disambiguation']
        db.delete_unique('dictionary_importglobalword', ['untranslated', 'type', 'grade', 'homograph_disambiguation'])

        # Deleting model 'ImportGlobalWord'
        db.delete_table('dictionary_importglobalword')
    ...
    models = {
        ...
        'dictionary.importglobalword': {
            'Meta': {'unique_together': "(('untranslated', 'type', 'grade', 'homograph_disambiguation'),)", 'object_name': 'ImportGlobalWord'},
            'braille': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'grade': ('django.db.models.fields.PositiveSmallIntegerField', [], {'db_index': 'True'}),
            'homograph_disambiguation': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'dictionary.localword': {
            ...
            'isDeferred': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
