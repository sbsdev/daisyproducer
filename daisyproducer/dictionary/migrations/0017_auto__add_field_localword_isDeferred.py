...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LocalWord.isDeferred'
        db.add_column('dictionary_localword', 'isDeferred', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LocalWord.isDeferred'
        db.delete_column('dictionary_localword', 'isDeferred')
