...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Image'
        db.create_table('documents_image', (
        ...
        db.send_create_signal('documents', ['Image'])

        # Adding field 'LargePrintProfile.end_notes'
        db.add_column('documents_largeprintprofile', 'end_notes',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('documents_image')

        # Deleting field 'LargePrintProfile.end_notes'
        db.delete_column('documents_largeprintprofile', 'end_notes')
