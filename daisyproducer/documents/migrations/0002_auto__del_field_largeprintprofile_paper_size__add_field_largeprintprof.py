...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LargePrintProfile.paper_size'
        db.delete_column('documents_largeprintprofile', 'paper_size')

        # Adding field 'LargePrintProfile.stock_size'
        db.add_column('documents_largeprintprofile', 'stock_size', self.gf('django.db.models.fields.CharField')(default='a4paper', max_length=16), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'LargePrintProfile.paper_size'
        db.add_column('documents_largeprintprofile', 'paper_size', self.gf('django.db.models.fields.CharField')(default='a4paper', max_length=16), keep_default=False)

        # Deleting field 'LargePrintProfile.stock_size'
        db.delete_column('documents_largeprintprofile', 'stock_size')
