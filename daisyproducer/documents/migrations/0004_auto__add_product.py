...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('documents_product', (
        ...
        db.send_create_signal('documents', ['Product'])


    def backwards(self, orm):
        
        # Deleting model 'Product'
        db.delete_table('documents_product')
    ...
    models = {
        ...
        'documents.largeprintprofile': {
            ...
            'replace_em_with_quote': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
