...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Image', fields ['content', 'document']
        db.create_unique('documents_image', ['content', 'document_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Image', fields ['content', 'document']
        db.delete_unique('documents_image', ['content', 'document_id'])
    ...
    models = {
        ...
        'documents.brailleprofile': {
            ...
            'detailed_accented_characters': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'enable_capitalization': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hyphenation': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lines_per_page': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '28', 'max_length': '4'}),
            'show_original_page_numbers': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'documents.document': {
            ...
            'publisher': ('django.db.models.fields.CharField', [], {'default': "'SBS Schweizerische Bibliothek f\\xc3\\xbcr Blinde, Seh- und Lesebehinderte'", 'max_length': '255'}),
        ...
        'documents.image': {
            'Meta': {'ordering': "['content']", 'unique_together': "(('document', 'content'),)", 'object_name': 'Image'},
            'content': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['documents.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'documents.largeprintprofile': {
            ...
            'alignment': ('django.db.models.fields.CharField', [], {'default': "'left'", 'max_length': '16'}),
            'end_notes': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '16'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'line_spacing': ('django.db.models.fields.CharField', [], {'default': "'onehalfspacing'", 'max_length': '16'}),
            'page_style': ('django.db.models.fields.CharField', [], {'default': "'plain'", 'max_length': '16'}),
            'replace_em_with_quote': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'documents.version': {
            'Meta': {'ordering': "['-created_at']", 'object_name': 'Version'},
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'content': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
